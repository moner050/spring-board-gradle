...
import com.my.springboardgradle.dto.request.ArticleCommentRequest;
import com.my.springboardgradle.service.ArticleCommentService;
...
class ArticleCommentControllerTest {
    ...
    void givenArticleCommentIdToDelete_whenRequesting_thenDeletesArticleComment() throws Exception {
        ...
        then(articleCommentService).should().deleteArticleComment(articleCommentId, "123qwe!");
    }
}